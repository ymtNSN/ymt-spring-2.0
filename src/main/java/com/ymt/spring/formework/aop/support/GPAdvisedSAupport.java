package com.ymt.spring.formework.aop.support;

import com.ymt.spring.formework.aop.aspect.GPAfterReturningAdviceInterceptor;
import com.ymt.spring.formework.aop.aspect.GPAfterThrowingAdviceInterceptor;
import com.ymt.spring.formework.aop.aspect.GPMethodBeforeAdviceInterceptor;
 ...
 */
public class GPAdvisedSAupport {
    ...
    public GPAdvisedSAupport(GPAopConfig config) {
        this.config = config;
    }
